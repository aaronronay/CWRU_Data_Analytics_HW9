...
* The nav must have similar behavior as the screenshots ["Navigation Menu" section](#navigation-menu) (notice the background color change).
...
* Alternatively, you may use the included [cities dataset](Resources/cities.csv) and pull the images from the [assets folder](Resources/assets).
* You must use bootstrap. 
* This includes using the bootstrap `navbar` component for the header on every page, 
* the bootstrap table component for the data page, 
